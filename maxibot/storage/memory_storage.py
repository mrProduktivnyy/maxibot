"""
Хранилище состояний в памяти — как `telebot.storage.memory_storage`.
Живёт, пока жив процесс; для переживания рестартов —
:class:`maxibot.storage.StatePickleStorage`.
"""
...
class StateMemoryStorage(StateStorageBase):
    """
    Хранилище по умолчанию (`MaxiBot(...)` без state_storage).
    Форма данных — как в telebot:
